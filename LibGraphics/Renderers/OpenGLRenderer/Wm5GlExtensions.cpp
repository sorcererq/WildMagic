		...
		if (*pcToken == '1')
		{
			...
			if (pcToken && *pcToken == '.')
			{
				...
				if (pcToken)
				{
					...
					{
					case '1':
						return GT_VERSION_1_1;
					case '2':
						return GT_VERSION_1_2;
					case '3':
						return GT_VERSION_1_3;
					case '4':
						return GT_VERSION_1_4;
					case '5':
						return GT_VERSION_1_5;
					}
				}
			}
		}
		...
		else if (*pcToken == '3')
		{
			...
			if (pcToken && *pcToken == '.')
			{
				...
				if (pcToken)
				{
					...
					{
					case '0':
						return GT_VERSION_3_0;
					case '1':
						return GT_VERSION_3_1;
					case '2':
						return GT_VERSION_3_2;
					case '3':
						return GT_VERSION_3_3;
					}
				}
			}
		}

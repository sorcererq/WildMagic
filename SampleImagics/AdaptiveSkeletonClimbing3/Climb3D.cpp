                             ...
                             VETable& table)
{
	...
	case  0:
		return;
	case  3:
		table.Insert(Edge3(EI_XMIN_YMIN, EI_XMIN_YMAX));
		break;
	case  5:
	...
	case 10:
		...
		break;
	case 12:
		table.Insert(Edge3(EI_XMIN_ZMIN, EI_XMIN_ZMAX));
		break;
	case 15:
	{
                             ...
                             VETable& table)
{
	...
	case  0:
		return;
	case  3:
		table.Insert(Edge3(EI_XMAX_YMIN, EI_XMAX_YMAX));
		break;
	case  5:
	...
	case 10:
		...
		break;
	case 12:
		table.Insert(Edge3(EI_XMAX_ZMIN, EI_XMAX_ZMAX));
		break;
	case 15:
	{
		// Four vertices, one per edge, need to disambiguate.
                             ...
                             VETable& table)
{
	...
	case  0:
		return;
	case  3:
		table.Insert(Edge3(EI_XMIN_YMIN, EI_XMAX_YMIN));
		break;
	case  5:
	...
	case 10:
		...
		break;
	case 12:
		table.Insert(Edge3(EI_YMIN_ZMIN, EI_YMIN_ZMAX));
		break;
	case 15:
	{
		// Four vertices, one per edge, need to disambiguate.
                             ...
                             VETable& table)
{
	...
	case  0:
		return;
	case  3:
		table.Insert(Edge3(EI_XMIN_YMAX, EI_XMAX_YMAX));
		break;
	case  5:
	...
	case 10:
		...
		break;
	case 12:
		table.Insert(Edge3(EI_YMAX_ZMIN, EI_YMAX_ZMAX));
		break;
	case 15:
	{
		// Four vertices, one per edge, need to disambiguate.
                             ...
                             VETable& table)
{
	...
	case  0:
		return;
	case  3:
		table.Insert(Edge3(EI_XMIN_ZMIN, EI_XMAX_ZMIN));
		break;
	case  5:
	...
	case 10:
		...
		break;
	case 12:
		table.Insert(Edge3(EI_YMIN_ZMIN, EI_YMAX_ZMIN));
		break;
	case 15:
	{
		// Four vertices, one per edge, need to disambiguate.
                             ...
                             VETable& table)
{
	...
	case  0:
		return;
	case  3:
		table.Insert(Edge3(EI_XMIN_ZMAX, EI_XMAX_ZMAX));
		break;
	case  5:
	...
	case 10:
		...
		break;
	case 12:
		table.Insert(Edge3(EI_YMIN_ZMAX, EI_YMAX_ZMAX));
		break;
	case 15:
	{
		// Four vertices, one per edge, need to disambiguate.

...
void Triangulation::DoExample0 ()
{
	...
	mPositions[0][0] =  29.0f;
	mPositions[0][1] = 139.0f;
	mPositions[1][0] =  78.0f;
	mPositions[1][1] =  99.0f;
	mPositions[2][0] = 125.0f;
	mPositions[2][1] = 141.0f;
	mPositions[3][0] = 164.0f;
	mPositions[3][1] = 116.0f;
	mPositions[4][0] = 201.0f;
	mPositions[4][1] = 168.0f;
	mPositions[5][0] = 157.0f;
	mPositions[5][1] = 163.0f;
	mPositions[6][0] = 137.0f;
	mPositions[6][1] = 200.0f;
	mPositions[7][0] =  98.0f;
	mPositions[7][1] = 134.0f;
	mPositions[8][0] =  52.0f;
	mPositions[8][1] = 146.0f;
	mPositions[9][0] =  55.0f;
	mPositions[9][1] = 191.0f;
...
void Triangulation::DoExample1 ()
{
	...
	mPositions.resize(7);
	mPositions[0][0] =  64.0f;
	mPositions[0][1] = 128.0f;
	mPositions[1][0] = 128.0f;
	mPositions[1][1] =  64.0f;
	mPositions[2][0] = 192.0f;
	mPositions[2][1] = 128.0f;
	mPositions[3][0] = 128.0f;
	mPositions[3][1] = 192.0f;
	mPositions[4][0] = 160.0f;
	mPositions[4][1] = 128.0f;
	mPositions[5][0] = 128.0f;
	mPositions[5][1] =  96.0f;
	mPositions[6][0] = 128.0f;
	mPositions[6][1] = 160.0f;
...
void Triangulation::DoExample4 ()
{
	...
	mPositions[ 0][0] = 102.0f;
	mPositions[ 0][1] =  15.0f;
	mPositions[ 1][0] = 233.0f;
	mPositions[ 1][1] =  87.0f;
	mPositions[ 2][0] = 184.0f;
	mPositions[ 2][1] = 248.0f;
	mPositions[ 3][0] =  33.0f;
	mPositions[ 3][1] = 232.0f;
	mPositions[ 4][0] =  14.0f;
	mPositions[ 4][1] = 128.0f;
	mPositions[ 5][0] = 137.0f;
	mPositions[ 5][1] =  42.0f;
	mPositions[ 6][0] =  93.0f;
	mPositions[ 6][1] =  41.0f;
	mPositions[ 7][0] = 137.0f;
	mPositions[ 7][1] =  79.0f;
	mPositions[ 8][0] = 146.0f;
	mPositions[ 8][1] =  66.0f;
	mPositions[ 9][0] = 161.0f;
	mPositions[ 9][1] = 213.0f;
	mPositions[10][0] = 213.0f;
	mPositions[10][1] = 113.0f;
	mPositions[11][0] = 108.0f;
	mPositions[11][1] =  67.0f;
	mPositions[12][0] =  36.0f;
	mPositions[12][1] = 153.0f;
	mPositions[13][0] =  89.0f;
	mPositions[13][1] = 220.0f;
	mPositions[14][0] = 133.0f;
	mPositions[14][1] = 186.0f;
	mPositions[15][0] = 147.0f;
	mPositions[15][1] = 237.0f;
	mPositions[16][0] = 177.0f;
	mPositions[16][1] = 237.0f;
	mPositions[17][0] = 184.0f;
	mPositions[17][1] = 202.0f;
	mPositions[18][0] = 159.0f;
	mPositions[18][1] = 225.0f;
	mPositions[19][0] =  86.0f;
	mPositions[19][1] = 113.0f;
	mPositions[20][0] = 115.0f;
	mPositions[20][1] = 118.0f;
	mPositions[21][0] =  98.0f;
	mPositions[21][1] = 134.0f;
	mPositions[22][0] = 109.0f;
	mPositions[22][1] = 153.0f;
	mPositions[23][0] =  68.0f;
	mPositions[23][1] = 133.0f;
	mPositions[24][0] =  68.0f;
	mPositions[24][1] = 156.0f;
	mPositions[25][0] = 115.0f;
	mPositions[25][1] = 175.0f;
	mPositions[26][0] = 108.0f;
	mPositions[26][1] = 194.0f;
	mPositions[27][0] =  80.0f;
	mPositions[27][1] = 192.0f;
	mPositions[28][0] = 163.0f;
	mPositions[28][1] = 108.0f;
	mPositions[29][0] = 185.0f;
	mPositions[29][1] = 108.0f;
	mPositions[30][0] = 172.0f;
	mPositions[30][1] = 176.0f;
	mPositions[31][0] =  79.0f;
	mPositions[31][1] = 170.0f;
	mPositions[32][0] =  79.0f;
	mPositions[32][1] = 179.0f;
	mPositions[33][0] =  88.0f;
	mPositions[33][1] = 179.0f;
	mPositions[34][0] =  88.0f;
	mPositions[34][1] = 170.0f;
	mPositions[35][0] =  96.0f;
	mPositions[35][1] = 179.0f;
	mPositions[36][0] =  96.0f;
	mPositions[36][1] = 187.0f;
	mPositions[37][0] = 103.0f;
	mPositions[37][1] = 187.0f;
	mPositions[38][0] = 103.0f;
	mPositions[38][1] = 179.0f;
	mPositions[39][0] = 169.0f;
	mPositions[39][1] = 121.0f;
	mPositions[40][0] = 169.0f;
	mPositions[40][1] = 131.0f;
	mPositions[41][0] = 178.0f;
	mPositions[41][1] = 131.0f;
	mPositions[42][0] = 178.0f;
	mPositions[42][1] = 121.0f;
